...
resourcename="northstarnomads"  # lower case, only
resourcegroup="northstarnomads_rg"
...
# git clone https://github.com/apilogicserver/northstarnomads.git
# cd northstarnomads
...
az group create --name northstarnomads_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group northstarnomads_rg --sku S1 --is-linux
az container create --resource-group northstarnomads_rg --name northstarnomads --image apilogicserver/northstarnomads:latest --dns-name-label northstarnomads --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//northstarnomads.westus.azurecontainer.io:5656'
