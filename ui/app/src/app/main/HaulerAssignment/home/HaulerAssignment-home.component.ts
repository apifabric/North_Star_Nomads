...
@Component({
  selector: 'HaulerAssignment-home',
  templateUrl: './HaulerAssignment-home.component.html',
  styleUrls: ['./HaulerAssignment-home.component.scss']
})
export class HaulerAssignmentHomeComponent implements AfterViewInit {
