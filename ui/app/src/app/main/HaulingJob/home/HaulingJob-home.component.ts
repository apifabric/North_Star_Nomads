...
@Component({
  selector: 'HaulingJob-home',
  templateUrl: './HaulingJob-home.component.html',
  styleUrls: ['./HaulingJob-home.component.scss']
})
export class HaulingJobHomeComponent implements AfterViewInit {
