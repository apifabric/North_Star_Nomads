...
@Component({
  selector: 'InspectorAssignment-home',
  templateUrl: './InspectorAssignment-home.component.html',
  styleUrls: ['./InspectorAssignment-home.component.scss']
})
export class InspectorAssignmentHomeComponent implements AfterViewInit {
