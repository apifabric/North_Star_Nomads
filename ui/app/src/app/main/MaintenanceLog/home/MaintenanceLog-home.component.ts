...
@Component({
  selector: 'MaintenanceLog-home',
  templateUrl: './MaintenanceLog-home.component.html',
  styleUrls: ['./MaintenanceLog-home.component.scss']
})
export class MaintenanceLogHomeComponent implements AfterViewInit {
