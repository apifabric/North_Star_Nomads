...
@Component({
  selector: 'RepairHistory-home',
  templateUrl: './RepairHistory-home.component.html',
  styleUrls: ['./RepairHistory-home.component.scss']
})
export class RepairHistoryHomeComponent implements AfterViewInit {
