...
@Component({
  selector: 'ServiceReport-home',
  templateUrl: './ServiceReport-home.component.html',
  styleUrls: ['./ServiceReport-home.component.scss']
})
export class ServiceReportHomeComponent implements AfterViewInit {
